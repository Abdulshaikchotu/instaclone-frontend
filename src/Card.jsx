    ...
    return (
        <>
            <div className="container">
                <div className="row1">
                    <p className="ptype1">{prop.post.name}</p>
                    <p className="ptype2">{prop.post.location}</p>
                </div>
                <div className="dot">
                ...
                <div className="image">
                    ...
                    <img src={prop.post.file} alt="asfs"></img>
                 ...
                 <div className="row3">
                    ...
                    <p>{prop.post.likes} likes</p>
                </div> 
                 <div className="date">{prop.post.date}</div>
                <div className="text">{prop.post.description}</div>
            </div>
            <br></br>
        </>
    );
